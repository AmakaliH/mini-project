...
<head>
  <meta charset="utf-8">
    ...
    <title>Clearance System | REGISTER</title>
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">                  
                    <div class="panel-heading">
                        <h3 class="panel-title">Please register to Clear Online</h3>
                    </div>
                    <div class="panel-body">
                        <form role="form" method="post" action="">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <input class="form-control" placeholder="student No." type="text"  name="reg_number" required="">
                                </div>
                                <div class="form-group">
